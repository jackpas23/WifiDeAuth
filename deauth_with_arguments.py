...
def deauth(target_mac, gateway_mac, inter=0.1, count=None, loop=1, iface="wlp4s0mon", verbose=1):
    # 802.11 frame
    #9A:9D:5D:D5:39:19  E4:5F:01:24:70:CF
    # addr1: destination MAC9A:9D:5D:D5:39:19  84:90:0A:55:54:E6
    # addr2: source MAC
